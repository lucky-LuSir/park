<template>
    <div class="not-position-notPaging_root" ref="myRoot">
        ...
        <div class="not-position_header">
            ...
            <el-button @click="exportReport()" size="small" class="select_button" icon="el-icon-download" type="success">导出
            </el-button>
        </div>

        <el-table :data="electricityReceivableList" e border size="small" :height="tableHeight" :summary-method="getSummaries" show-summary>
            <el-table-column align="center" label="序号" type="index">
            </el-table-column>
            <el-table-column align="center" label="合同编号" width="120" prop="ctName">
            </el-table-column>
            <el-table-column align="center" label="合同状态" width="90" prop="ctStatusName">
            </el-table-column>
            ...
            <el-table-column align="center" label="电费是否含税" prop="hasTax">
            ...
            <el-table-column header-align="center" label="操作" width="80">
                <template slot-scope="scope">
                    <el-button v-if="scope.row.payStatus != '2'" @click="costDeatil(scope.row.ctCode, scope.row.ctStatus)" type="text">缴费
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    export default {
        ...
        data() {
            return {
                ...
                electricityReceivableList: [], // 租金集合
                selectMonth: '', // 选择的月
        ...
        methods: {
            ...
            selectReport() {
                ...
                let options = {
                    method: 'POST',
                    data: params,
                    url: "electricityReceivable/select",
                };
                ...
                this.$ajax(
                    ...
                    if (response) {
                        vm.electricityReceivableList = response.data.result;
                    }
                }).catch(error => {
            ...
            exportReport() {
                ...
                // 本地测试打开
                //                window.location.href="http://localhost:8380/park/electricityReceivable/exportEleReceivableBiExcel" +
                //                    "?startDate=" + startDate + "&endDate=" + endDate + "&contractorDeptCode=" + contractorDeptCode + "&pkCode=" + pkCode;

                // 发布线上打开
                window.location.href = "/park/electricityReceivable/exportEleReceivableBiExcel" +
                    "?startDate=" + startDate + "&endDate=" + endDate + "&contractorDeptCode=" + contractorDeptCode + "&pkCode=" + pkCode;
            }
        }
    }
