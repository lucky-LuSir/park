<template>
    <div class="has-position_root" ref="myRoot">
        ...
        <div class="has-position_header">
            <el-button type="primary" style="margin-left: 20px;" size="small" @click="submitForm('landlordObj')">
                保存
            </el-button>
        </div>
        ...
        <el-form :model="landlordObj" label-width="100px" :rules="rules" ref="landlordObj" labelSuffix="：" class="form_style">
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
                        <el-form-item label="单位" prop="rentUnit">
                            <el-radio-group v-model="landlordObj.rentUnit" style="width: 250px">
            ...
            <div class="common_content_div">
                ...
                <el-row style="padding-bottom: 15px;">
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" v-for="(item, index) in fileList" :key="item">
            ...
            <div class="common-title-div" style="border-bottom: solid white">
            ...
            <div style="height: 50px;margin-top: 20px;">
                <el-button style="float: left;margin-left: 45%;" type="primary" @click="submitForm('landlordObj')">
                    保存
                </el-button>
        ...
        <el-dialog class="hasfooter-dialog_wrapper" :title="windowTitle"
...
//                        return 0;
//                    }
                    if (rentPrice && rentTaxPrice && propertyPrice && propertyTaxPrice && otherPrice ) {
                        let totalPrice = Number(rentPrice) + Number(rentTaxPrice) + Number(propertyPrice) + Number(propertyTaxPrice) + Number(otherPrice);
                        this.landlordRentObj.totalPrice = totalPrice.toFixed(2);
                        return totalPrice.toFixed(2);
                    } else {
                        return 0;
        ...
        methods: {
            ...
            getEmpObj(val) {
                ...
                this.landlordObj.contractorDeptCode = obj.deptCode;
            },
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.fileList.length > 0) {
                            this.landlordObj.contractUrl = this.fileList.join('，');
                        } else {
                            this.landlordObj.contractUrl = '';
                            this.$alert('提示：请上传文件附件', '温馨提示', {
                                confirmButtonText: '确定',
                                callback: action => {
                                }
                            });
                        ...
                        if (this.landlordObj.hasDetailAdd == true) {
                            ...
                            for (let i = 0; i < this.progressiveIncreaseDetailList.length; i++) {
                                arr.push(this.progressiveIncreaseDetailList[i].value);
                            }
                            this.landlordObj.progressiveIncreaseDetail = arr.join(',');
                        }
                        let obj = {
                            entity: this.landlordObj
                        };

                        let options = {
                            method: 'POST',
                            data: obj,
                            url: 'landlordRentApply/create'
                        };
