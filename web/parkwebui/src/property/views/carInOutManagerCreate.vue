                    ...
                    <el-row>
                        <el-col :xs="15" :sm="14" :md="13" :lg="12" :xl="12">
                            <el-form-item label="园区" prop="pkCode">
                                <el-select size="small" v-model="dataObj.pkCode" filterable  placeholder="选择园区" @change="changePk">
                                    <el-option
                                ...
                                <span class="null_cus" @click="setDefaultPk">&nbsp;&nbsp;设为默认园区</span>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="被访客户/公司" prop="cusCode">
                                <!--<el-select size="small" v-model="dataObj.cusCode" filterable  clearable placeholder="选择客户" @change="getRelateInfo">
                                    <el-option
                        ...
                        <el-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="被访人" prop="beVisitorName">
                                <el-input size="small" v-model="dataObj.beVisitorName" placeholder="被访人"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col  :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="被访人手机号" prop="beVisitorPhone">
                                <el-input size="small" v-model="dataObj.beVisitorPhone" placeholder="被访人手机号"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-card>
                    ...
                    <el-row>
                        <el-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="进出类型" prop="inOutType">
                                <el-radio v-model="dataObj.inOutType" label="1">车辆进出</el-radio>
                                <el-radio v-model="dataObj.inOutType" label="2" @change="selectPerson">人员进出</el-radio>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row>
                        <el-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="来访人" prop="visitor">
                                <el-input size="small" v-model="dataObj.visitor"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="来访人手机号" prop="visitorPhone">
                                <el-input size="small" v-model="dataObj.visitorPhone"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="8" :sm="8" :md="9" :lg="8" :xl="8">
                            <el-form-item label="身份证" prop="visitorIdCard">
                                <el-input size="small" v-model="dataObj.visitorIdCard"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <el-row>
                        <el-col :xs="8" :sm="8" :md="6" :lg="8" :xl="8">
                            <el-form-item label="来访人数" prop="visitorNum">
                                <el-input size="small" v-model="dataObj.visitorNum"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :xs="9" :sm="9" :md="10" :lg="9" :xl="9">
                            <el-form-item label="来访目的" prop="visitPurpose">
                                <el-input size="small" type="textarea" v-model="dataObj.visitPurpose"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-card>
...
export default{
    ...
    methods:{
        ...
        selectDefaultPkCode(){
            ...
            this.$ajax(
                ...
                if(response){
                    let data = response.data.result;
                    if(data.length > 0){
                        vm.defaultPkCode = data[0].pkCode;
                        vm.dataObj.pkCode = vm.defaultPkCode;
                        vm.selectCus();
                    }
                }
            })
        ...
        setDefaultPk(){
            ...
            let params = {
                entity: {
                    ...
                    buttJointType: '3',
                    postName: '保安',
                    dutyDescription: '园区人员进出管理'
                }
            }
            let options = {
                method: "POST",
                data: params,
                url: "/parkButtJoint/createDefaultPk"
            }
            this.$ajax(
                options
            ).then(response => {
        ...
        querySearchCus(queryString, cb){
            ...
            let results = queryString ? cusNames.filter(this.createFilter(queryString)) : cusNames;
            cb(results);
        },
