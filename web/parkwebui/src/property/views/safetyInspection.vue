            ...
            <div class="not-position_header">
                <div class="search_buttons">
                    <div style="float: left;">
                        ...
                        <el-button icon="el-icon-search" style="margin-left: 20px" type="primary" @click="selectInfo" size="small">
                            搜索
                        </el-button>
                        <el-button icon="el-icon-setting" style="margin-left: 20px" type="info" @click="templateManager" size="small">
                            检查项目
                        </el-button>
                        <el-button icon="el-icon-s-order" style="margin-left: 20px" type="info" @click="taskManager" size="small">
                            检查清单
                        </el-button>
                    </div>
