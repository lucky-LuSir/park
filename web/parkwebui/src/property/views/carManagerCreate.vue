            ...
            <el-form
                ...
                <el-card class="task_select">
                    <div slot="header" style="text-align: center">
                        <span style="font-size: 25px">新建车辆信息</span>
                    </div>
                    <el-row>
                        <el-col :xs="12" :sm="12" :md="12"  :lg="12" :xl="8">
                            <el-form-item label="园区" prop="pkCode">
                                <el-select filterable  size="small" v-model="createInfo.pkCode" placeholder="选择园区" @change="changePk">
                                    <el-option
                        ...
                        <el-col :xs="12" :sm="12" :md="12"  :lg="12" :xl="8">
                            <el-form-item label="客户" prop="cusCode">
                                <el-select size="small" v-model="createInfo.cusCode" filterable  clearable placeholder="选择客户">
                                    <el-option
                        ...
                        <el-col :xs="12" :sm="12" :md="12"  :lg="12" :xl="8">
                            <el-form-item label="车牌号" prop="licenseNum">
                                <el-input size="small" v-model="createInfo.licenseNum" placeholder="车牌号"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="12" :sm="12" :md="12"  :lg="12" :xl="8">
                            <el-form-item label="车主姓名" prop="carOwnerName">
                                <el-input size="small" v-model="createInfo.carOwnerName" placeholder="车主姓名"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="12" :sm="12" :md="12"  :lg="12" :xl="8">
                            <el-form-item label="车主手机号" prop="carOwnerPhone">
                                <el-input size="small" v-model="createInfo.carOwnerPhone" placeholder="车主手机号"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="12" :sm="12" :md="12"  :lg="12" :xl="8">
                            <el-form-item label="车主身份证" prop="carOwnerIdCard">
                                <el-input size="small" v-model="createInfo.carOwnerIdCard" placeholder="车主身份证"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    ...
                    <div style="float: right; padding-bottom: 10px">
                        <el-button type="info" @click="closeCreate">取消</el-button>
                        <el-button type="primary" @click="beforeSubmit('createInfo')">提交</el-button>
                    </div>
                </el-card>
            </el-form>
        </el-dialog>
...
<script>
    ...
    export default {
        ...
        data(){
            ...
            return {
                drivingLicenceList: [], //驾驶证图片
                vehicleLicenseList: [], //行驶证图片
        ...
        methods: {
            ...
            submitInfo(ruleFormVal){
                this.$refs[ruleFormVal].validate(async (valid) => {
                    if (valid){
                        ...
                        this.createInfo.drivingLicence = this.drivingLicenceList.join(',');
                        this.createInfo.vehicleLicense = this.vehicleLicenseList.join(',');

                        this.createInfo.pkName = this.parkNames[this.createInfo.pkCode];
                        this.createInfo.company = this.cusObj[this.createInfo.cusCode];
                        var entity = this.createInfo;
                        const res = await this.$ajax.post('carManager/create', {
                            entity
                        });
                        if(res){
                            this.$message({
            ...
            async beforeSubmit(ruleFormVal){
                let entity = {
                    pkCode: this.createInfo.pkCode,
                    licenseNum: this.createInfo.licenseNum
                }
