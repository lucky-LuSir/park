    ...
    <div class="root" ref="myRoot">
        <el-form :model="roomObj" :rules="rules" ref="roomObj" label-width="110px">
            <div class="back-button-root-div" v-bind:style="{width:floatDivWidth+'px'}">
                ...
                <span class="back-button-title">{{roomObj.pkName}} - {{roomObj.bdName}} - 房间修改</span>
...
<script>
    ...
    export default{
        ...
        created: function () {
            var vm = this;
            vm.roomObj = vm.$route.query.paramsObj;
        },
        methods: {
            //返回按钮
            goBack1(){
