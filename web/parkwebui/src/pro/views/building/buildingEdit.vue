<template>
    <div class="has-position_root" ref="myRoot">
        <div class="has-position_header">
            ...
            <span class="menu-info_span">当前位置：修改{{buildingObj.pkName}} - {{buildingObj.bdName}} 栋信息</span>
        </div>
        ...
        <el-form class="has-position_main" :model="buildingObj" :rules="rules" ref="buildingObj" label-width="120px">
            ...
            <div class="building-info-root-div">
                ...
                <el-row class="building-input" :gutter="20">
                    <el-col :span="6">
                        <div class="grid-content">
                            <el-form-item label="货梯数量 :" prop="elevatorQuantity">
                                <!--用数据库电梯数量字段-->
                                <el-input class="input-text" v-model="buildingObj.elevatorQuantity"></el-input>
                            </el-form-item>
                        </div>
                    </el-col>
                    ...
                    <el-col :span="6">
                        <div class="grid-content">
                            <el-form-item label="货梯承重 :" prop="freightElevatorWeight">
                                <el-input class="input-text" v-model="buildingObj.freightElevatorWeight">
...
<script>
    ...
    export default {
        ...
        created: function() {
            ...
            param = this.paramsObj.paramsObj;
            if (param) {
                pkCode = param.pkCode;
                pkName = param.pkName;
                thisBuilding = param.thisBuilding;

                buildingVideo = param.buildingVideo;
                outPicture = param.outPicture;

                vm.buildingObj.pkCode = pkCode;
                vm.buildingObj.pkName = pkName;
                vm.buildingObj.thisBuilding = thisBuilding;
                    ...
                    if (valid) {
                        ...
                        this.$ajax(
                            ...
                            if (!response.data.isException) {
                                ...
                                vm.$emit('backParam', dataDetailObj);
                            } else {
                                vm.$message({
                                    showClose: true,
