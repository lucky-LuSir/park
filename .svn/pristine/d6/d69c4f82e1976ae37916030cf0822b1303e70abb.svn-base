<template>
    <div>
        <el-button size="mini" plain round @click="openWindow()" v-if="ctObj" style="color: rgb(103, 194, 58);">
            抄水表
        </el-button>

        <!-- 抄电表 -->
        <el-dialog title="抄水表" class="hasfooter-dialog_wrapper" top="10vh" style="text-align: center;" :visible.sync="recordMeterWindow" append-to-body width="80%" :close-on-press-escape="false" :close-on-click-modal="false">
            ...
            <el-card v-for="(item, index) in contractList" :key="index" style="margin-bottom: 20px;" shadow="hover">
                ...
                <div v-for="(itemEle, indexEle) in item.waterMeterList" :key="indexEle">
                    <el-form :model="itemEle.waterRecordEntity" ref="itemEle.waterRecordEntity" labelSuffix="：" :rules="rules" style="text-align: left;" label-width="130px">
                            ...
                            <el-row :gutter="20">
                                ...
                                <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
                                    <el-form-item label="所属月份" prop="recordMonth">
                                        <el-date-picker v-model="itemEle.waterRecordEntity.recordMonth" type="month" placeholder="选择月">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="20" v-if="itemEle.waterBillingType == '2'">
                                ...
                                <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
                                    <el-form-item label="本次见表" prop="currentBillingWater">
                                        <el-input v-model="itemEle.waterRecordEntity.currentBillingWater" @change="computedCurrentBillingWater(index, indexEle)" clearable>
        ...
        methods: {
            ...
            openWindow() {
                ...
                let params = {
                    ...
                    waterMeterCode: vm.meterObj.waterMeterCode
                };
                                ...
                                if (waterMeterList.length != 0) {
                                    for (let j = 0; j < waterMeterList.length; j++) {
                                        ...
                                        if (waterMeterList[j].waterRecordEntity.waterRecordCode != null) {
                                            ...
                                            waterMeterList[j].waterRecordEntity.recordMonth = '';
