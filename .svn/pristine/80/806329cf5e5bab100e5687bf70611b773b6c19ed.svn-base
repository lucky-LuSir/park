...
//        String ctime = formatter.format(time);
     ...
     */
    public static BigDecimal daysBetween(Date smdate, Date bdate)
    {
        Calendar cal = Calendar.getInstance();
        cal.setTime(smdate);
        ...
        BigDecimal result = new BigDecimal(between_days);
        return result;
    }

    /**
     *@author gtaotao
     *@Date 2019-07-31 15:43:19
     *@Description 获取某月的前(或后)几个月的第一天
     *@param num 几个月
     *@return
     **/
    public static Date getSomeMonthBegin(Date month, int num){
        Calendar c = Calendar.getInstance();
        c.setTime(month);
    ...
    /**
     *@author gtaotao
     *@Date 2019-07-31 15:37:04
     *@Description 获取某月的前(或后)几个月的最后一天
     *@param num 几个月
     *@return
     **/
    public static Date getSomeMonthEnd(Date month, int num) {
    ...
    /**
     *@author gtaotao
     *@Date 2019-08-15 11:40:30
     *@Description 获取时间的年、月
     *@param
     *@return
     **/
    public static Map<String, String> getYearAndMonth(Date date){
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
...
//        System.out.print(dateToString(new Date(), "yyyy年MM月dd日"));
        ...
        Date start = df.parse("2019-06-01 00:00:00");
        Date end = df.parse("2019-06-30 23:59:59.999");
        BigDecimal result = daysBetween(start, end);
