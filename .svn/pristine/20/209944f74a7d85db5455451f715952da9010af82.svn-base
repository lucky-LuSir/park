<template>
  <div class="totalKanban">
    ...
    <el-row class="totalKanbanMain" type="flex">
      <el-col :span="8">
        <div @click="to_kanban($event, 1)" ref="oneChartsBox" class="oneChartsBox">
          <div id="oneCharts" ref="oneCharts" class="oneCharts"></div>
        </div>
      </el-col>
      <el-col :span="8">
        <div @click="to_kanban($event, 2)" ref="twoChartsBox" class="twoChartsBox">
          <div id="twoCharts" ref="twoCharts" class="twoCharts"></div>
        </div>
      </el-col>
      <el-col :span="8">
        <div @click="to_kanban($event, 2)" ref="threeChartsBox" class="threeChartsBox">
...
export default {
    ...
    updated() {
        document.querySelector("#oneCharts").style.width =
            (window.innerWidth - 250) / 3 + "px";
        document.querySelector("#twoCharts").style.width =
            (window.innerWidth - 250) / 3 + "px";
        document.querySelector("#threeCharts").style.width =
            (window.innerWidth - 250) / 3 + "px";
    },
    methods: {
        showEcharts(res) {
            ...
            var threeChartsOption = {
                ...
                legend: {
                    formatter: function(name) {
                        if (name === "空置面积：") {
                            return name + " " + totalRentInvestArea + "㎡";
                        }
                        if (name === "在租面积：") {
                            return name + " " + totalRentableArea + "㎡";
                        }
                    },
                    orient: "vertical",
                    x: "center",
                ...
                series: [
                    {
                        ...
                        data: [
                            { value: totalRentInvestArea, name: `空置面积：` },
                            { value: totalRentableArea, name: `在租面积：` }
                        ]
                    }
                ],
                color: ["#5ddcff", "#4387fd"]
