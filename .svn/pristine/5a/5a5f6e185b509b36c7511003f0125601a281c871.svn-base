...
import com.gniuu.framework.common.constants.ContextConstants;
...
import com.kfwy.park.common.utils.MediaTypeUtils;
...
public class FileService extends SpringRestService {
    ...
    public ResponseEntity<IServiceResponse> upload(@RequestParam("file") MultipartFile[] files,
                                                   @RequestParam(name = "parentCode", required = false) String parentCode,HttpServletRequest request) {

        FileServiceResponse response = new FileServiceResponse();

//        String tk = request.getHeader(ContextConstants.request_cookie_token);
//        String param = request.getParameter(ContextConstants.request_cookie_token);
