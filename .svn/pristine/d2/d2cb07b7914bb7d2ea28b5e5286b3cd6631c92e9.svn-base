<template>
    ...
    <div class="has-position_root" ref="myRoot">
        ...
        <el-form class="has-position_main" ref="floorObj" :rules="rules" :model="floorObj" label-width="100px">
            <!--第一个方框-->
            <div class="block_box">
                ...
                <el-row :gutter="50">
                    ...
                    <el-col :xs="7" :sm="7" :md="7" :lg="7" :xl="7">
                        <div class="grid-content">
                            <el-form-item label="单价" prop="floorUnitPrice">
                                <el-input placeholder="请输入..." v-model="floorObj.floorUnitPrice">
                                    <el-select slot="append" prop="priceUnit" v-model="floorObj.priceUnit"
                        ...
                        <div class="grid-content">
                            <el-form-item label="承租单价" prop="tenantPrice">
                                <el-input placeholder="请输入..." v-model="floorObj.tenantPrice">
                                    <el-select slot="append" prop="tenantUnit" v-model="floorObj.tenantUnit"
                                               placeholder="请选择" style="width: 100px">
                                        <el-option
                                                v-for="item in options"
                                                :key="item.value"
                    ...
                    <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
                        <div class="grid-content">
                            <el-form-item label="计租面积" prop="investArea">
                                <el-input placeholder="请输入..." v-model="floorObj.investArea">
            ...
            <div class="block_box" style="margin-top: 10px;">
                    ...
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <div style="height: 160px; line-height: 160px;">
                            ...
                            <div class="grid-content picture_add">
                                <div class="picture_add_img" v-if="fileType == 'image'"
                                     v-for="(item, index) in aerialViewList">
                ...
                <el-row>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <div style="height: 160px; line-height: 160px;">
                            <div class="picture_type">
                                <span class="picture_type_span">户型图&nbsp&nbsp&nbsp</span>
                            </div>
                            <div class="grid-content picture_add">
                                <div class="picture_add_img" v-if="fileType == 'image'"
                                     v-for="(item, index) in outPictureList">
                                    <img style="width: 100%;height: 100%;" :src=" parkBaseUrl + 'file/read/' + item ">
                ...
                <el-row>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <div style="height: 160px; line-height: 160px;">
                            ...
                            <div class="grid-content picture_add">
                                <div class="picture_add_img" v-if="fileType == 'image'"
                                     v-for="(item, index) in internalDiagramList">
                                    <img style="width: 100%;height: 100%;" :src=" parkBaseUrl + 'file/read/' + item ">
...
<script>
    ...
    export default {
        ...
        created: function () {
            ...
            if (vm.paramsObj.paramsObj) {

                vm.floorObj = vm.paramsObj.paramsObj;

                if (vm.floorObj.pkCode && vm.floorObj.bdCode) {
                    if (!vm.floorObj.flCode) {
                        //楼层新增页
                        vm.creOrupdate = "create";
                        this.$message('floorEdit.vue--created方法中flCode楼层编码为空,联系管理员!');

                    } else {
                        //楼层编辑页
                        vm.creOrupdate = "update";
                        ...
                        //初始化用途集合
                        let checkList = vm.floorObj.useType.split(",");
                        vm.checkUseType = checkList;
                    }
                } else {
                    vm.$message({
                        showClose: true,
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    tenantPrice: [
                        {required: true, message: '请输入承租单价', trigger: 'blur'},
                        {validator: checkNumber},
                        {validator: checkIntOrFloat},
                    ],
                    tenantUnit: [
                        {required: true, message: '请选择承租单价单位', trigger: 'change'},
                    ],
                    floorHeight: [
                    ...
                    floorBearWeight: [
                        {required: true, message: '请输入地坪承重', trigger: 'blur'},
                        {validator: checkNumber},
                        {validator: checkIntOrFloat},
                    ],
                    floorType: [
                        {required: true, message: '请选择地坪', trigger: 'change'}
                    ],
                    decorationType: [
                        {required: true, message: '请选择装修类型', trigger: 'blur'}
                    ],
                    floorDeep: [
                        {required: true, message: '请输入长*宽', trigger: 'blur'}
                    ],
                    pillarSpacing: [
                        {required: true, message: '请输入柱距', trigger: 'blur'},
                        {validator: checkNumber},
                        {validator: checkIntOrFloat},
                    ],
                    useType: [
            ...
            submitForm(subForm) {
                ...
                if (vm.checkUseType.length > 0) {
                    for (let i = 0; i < vm.checkUseType.length; i++) {
                        if (i == 0) {
                            vm.floorObj.useType = vm.checkUseType[i];
                        } else {
                            vm.floorObj.useType = vm.floorObj.useType + "," +vm.checkUseType[i];
                        }
                    }
                } else {
                    vm.$message({
                            ...
                            if (!response.data.isException) {
                                ...
                                let dataDetail = {
                                    ...
                                    params: {
                                        ...
                                        flCode: vm.floorObj.flCode,
                                        thisFloor: vm.floorObj.thisFloor
                                    }
                                };
                                vm.$emit('backParam', dataDetail);
