package com.kfwy.park.common.easyexcel.export.impl;


import com.kfwy.park.common.easyexcel.export.domain.common.ExportCell;
...
import com.kfwy.park.common.easyexcel.export.service.IFileExportor;
import com.kfwy.park.common.easyexcel.util.ReflectionUtils;
    ...
    private static void setCellValue(Object obj, Cell cell,Workbook workbook) throws FileExportException {
        if (obj != null) {
            ...
            if (classType.endsWith("String")) {
                ...
                cell.setCellValue(com.kfwy.park.common.easyexcel.util.DateUtil.dateToString((Date) obj, com.kfwy.park.common.easyexcel.util.DateUtil.YYYYMMDD));
            }
...
//                bigDecimal = new BigDecimal(bigDecimal.doubleValue());
             ...
             //   cell.setCellValue(((Boolean) obj).booleanValue());
                if(obj.equals("")){
                    ...
                    cell.setCellValue((Boolean) obj == true ? "是" : "否");
                }
